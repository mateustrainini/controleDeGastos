            ...
            row.innerHTML = `
                ...
                <td>
                    <div class="actions-container">
                        <button type="button" class="action-button btnEditEarning"><span class="bi bi-pencil" style="color: #ffd000;"></span></button>
                        <button type="button" class="action-button btnDeleteEarning"><span class="bi bi-trash" style="color: red;"></span></button>
                    </div>
                </td>
            `;
